...
async def button_click(update: Update, context):
    ...
    if data == "about":
        ...
        instagram_link = "https://www.instagram.com/iraqcartoon_"
        youtube_link = "https://www.youtube.com/@iraqcartoon"
        tiktok_link = "https://www.tiktok.com/@iraqcartoon"
        ...
        caption = (
            ...
            "📸 **إنستجرام - لحظات تنبض بالجمال!**\n"
            "🎨 استمتع بأروع الصور والفيديوهات الحصرية التي تنقل لك روح الحدث.\n"
            "💬 تفاعل معنا وشاركنا رأيك في التعليقات!\n"
            f"🔗 **اكتشف عالمنا البصري:** [اضغط هنا]({instagram_link})\n\n\n"

            "▶️ **يوتيوب - حيث تتحول اللحظات إلى ذكريات!**\n"
            "🎥 شاهد محتوى مميز، لقاءات حصرية، وتغطيات فريدة.\n"
            "🔔 لا تفوّت أي فيديو جديد، اشترك وفعل الجرس!\n"
            f"🔗 **اشترك الآن:** [اضغط هنا]({youtube_link})\n\n\n"

            "🎵 **تيك توك - محتوى ممتع وإبداعي!**\n"
            "🔥 استمتع بمقاطع فيديو قصيرة ومميزة تعكس أروع اللحظات.\n"
            "🎶 انضم إلينا وكن جزءًا من مجتمعنا التفاعلي!\n"
            f"🔗 **تابعنا على تيك توك:** [اضغط هنا]({tiktok_link})\n\n\n"
        )
